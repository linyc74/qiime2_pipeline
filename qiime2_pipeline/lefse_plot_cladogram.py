"""
This script is a modified version of the lefse_plot_cladogram.py script from the LEfSe package (https://github.com/SegataLab/lefse/tree/master/lefse).
"""
import string
import pandas as pd
from pylab import *
...
class LefSePlotCladogram:
    ...
    PARAMS = {
        ...
        'min_point_size': 1,
        'markeredgewidth': .25,
        'siblings_connector_width': 2,
        'parents_connector_width': 0.75,
        'radial_start_lev': 1,
        'labeled_start_lev': 2,
        'labeled_stop_lev': 5,
        'abrv_start_lev': 3,
        ...
        'expand_void_lev': 1,
        'class_legend_vis': 1,
        'colored_connectors': 1,
        'alpha': 0.2,
        'title': 'Cladogram',
        'sub_clade': '',
        'title_font_size': 14,
        'r_prop': 0.1,  # right_space_prop
        'l_prop': 0.1,  # left_space_prop
        'label_font_size': 6,
        'back_color': 'w',  # background_color choices=['k', 'w']
        'col_lab': 1,  # colored_labels choices=[0,1]
    ...
    def extract_data_and_plot(self):
        ...
        clad_tree = read_data(self.input_file, self.params)
        draw_tree(self.output_file, clad_tree, self.params)


# This should be useless because I'm not using dark colors
